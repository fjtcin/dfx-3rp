proc cr_bd_CSRenc { parentCell designName } {
...
##################################################################
  ...
  # Create instance: csr_enc_0, and set properties
  set csr_enc_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:csr_enc:1.0 csr_enc_0 ]
  ...
  connect_bd_intf_net -intf_net csr_enc_0_out_r [get_bd_intf_pins csr_enc_0/out_r] [get_bd_intf_pins rm_comm_box_0/s2mm_axis]
  connect_bd_intf_net -intf_net mux_3_1_0_out_r [get_bd_intf_pins csr_enc_0/in_r] [get_bd_intf_pins mux_3_1_0/out_r]
  ...
  connect_bd_net -net AccelConfig_0_ap_start [get_bd_pins AccelConfig_0/ap_start] [get_bd_pins csr_enc_0/ap_start]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins AccelConfig_0/clk] [get_bd_pins csr_enc_0/ap_clk] [get_bd_pins mux_3_1_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rm_comm_box_0/clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net csr_enc_0_ap_done [get_bd_pins AccelConfig_0/ap_done] [get_bd_pins csr_enc_0/ap_done]
  connect_bd_net -net csr_enc_0_ap_idle [get_bd_pins AccelConfig_0/ap_idle] [get_bd_pins csr_enc_0/ap_idle]
  connect_bd_net -net csr_enc_0_ap_ready [get_bd_pins AccelConfig_0/ap_ready] [get_bd_pins csr_enc_0/ap_ready]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins AccelConfig_0/resetn] [get_bd_pins csr_enc_0/ap_rst_n] [get_bd_pins mux_3_1_0/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rm_comm_box_0/resetn]
