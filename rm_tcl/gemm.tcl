proc cr_bd_GEMM { parentCell designName } {
...
xilinx.com:hls:gemm:1.0\
xilinx.com:hls:mux_1_2:1.0\
xilinx.com:hls:mux_2_1:1.0\
...
##################################################################
  ...
  set AXIS_IN0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 AXIS_IN0 ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M_AXI_GMEM:S_AXI_CTRL:AXIS_IN0:AXIS_OUT1} \
 ] $clk
  ...
  # Create instance: gemm_0, and set properties
  set gemm_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:gemm:1.0 gemm_0 ]

  # Create instance: mux_1_2_0, and set properties
  set mux_1_2_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mux_1_2:1.0 mux_1_2_0 ]

  # Create instance: mux_2_1_0, and set properties
  set mux_2_1_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mux_2_1:1.0 mux_2_1_0 ]
  ...
  connect_bd_intf_net -intf_net AXIS_IN0_1 [get_bd_intf_ports AXIS_IN0] [get_bd_intf_pins mux_2_1_0/in1]
  connect_bd_intf_net -intf_net AccelConfig_0_tid0_axis [get_bd_intf_pins AccelConfig_0/tid0_axis] [get_bd_intf_pins mux_2_1_0/in0]
  connect_bd_intf_net -intf_net S_AXI_CTRL_1 [get_bd_intf_ports S_AXI_CTRL] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net gemm_0_out_r [get_bd_intf_pins gemm_0/out_r] [get_bd_intf_pins mux_1_2_0/in_r]
  connect_bd_intf_net -intf_net mux_1_2_0_out0 [get_bd_intf_pins mux_1_2_0/out0] [get_bd_intf_pins rm_comm_box_0/s2mm_axis]
  connect_bd_intf_net -intf_net mux_1_2_0_out1 [get_bd_intf_ports AXIS_OUT1] [get_bd_intf_pins mux_1_2_0/out1]
  connect_bd_intf_net -intf_net mux_2_1_0_out_r [get_bd_intf_pins gemm_0/in_r] [get_bd_intf_pins mux_2_1_0/out_r]
  ...
  connect_bd_net -net AccelConfig_0_ap_start [get_bd_pins AccelConfig_0/ap_start] [get_bd_pins gemm_0/ap_start]
  connect_bd_net -net AccelConfig_0_interrupt [get_bd_pins AccelConfig_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net AccelConfig_0_scalar1 [get_bd_pins AccelConfig_0/scalar1] [get_bd_pins mux_1_2_0/opcode] [get_bd_pins mux_2_1_0/opcode]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins AccelConfig_0/clk] [get_bd_pins gemm_0/ap_clk] [get_bd_pins mux_1_2_0/ap_clk] [get_bd_pins mux_2_1_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rm_comm_box_0/clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net gemm_0_ap_done [get_bd_pins AccelConfig_0/ap_done] [get_bd_pins gemm_0/ap_done]
  connect_bd_net -net gemm_0_ap_idle [get_bd_pins AccelConfig_0/ap_idle] [get_bd_pins gemm_0/ap_idle]
  connect_bd_net -net gemm_0_ap_ready [get_bd_pins AccelConfig_0/ap_ready] [get_bd_pins gemm_0/ap_ready]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins AccelConfig_0/resetn] [get_bd_pins gemm_0/ap_rst_n] [get_bd_pins mux_1_2_0/ap_rst_n] [get_bd_pins mux_2_1_0/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rm_comm_box_0/resetn]
